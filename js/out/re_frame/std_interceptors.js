...
var vec__19561_19564 = clojure.data.diff(orig_db,new_db);
var only_before_19565 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19561_19564,(0),null);
var only_after_19566 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19561_19564,(1),null);
var db_changed_QMARK__19567 = (!((only_before_19565 == null))) || (!((only_after_19566 == null)));
if(db_changed_QMARK__19567){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before:",only_before_19565], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after :",only_after_19566], 0));
...
var map__19574 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__19574__$1 = ((((!((map__19574 == null)))?((((map__19574.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19574.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19574):map__19574);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19574__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19574__$1,cljs.core.cst$kw$event);
...
var map__19582 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__19582__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19582__$1,cljs.core.cst$kw$event);
...
var len__7910__auto___19585 = arguments.length;
var i__7911__auto___19586 = (0);
while(true){
if((i__7911__auto___19586 < len__7910__auto___19585)){
args__7917__auto__.push((arguments[i__7911__auto___19586]));

var G__19587 = (i__7911__auto___19586 + (1));
i__7911__auto___19586 = G__19587;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7918__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq19584){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19584));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__6797__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__7917__auto__ = [];
var len__7910__auto___19593 = arguments.length;
var i__7911__auto___19594 = (0);
while(true){
if((i__7911__auto___19594 < len__7910__auto___19593)){
args__7917__auto__.push((arguments[i__7911__auto___19594]));

var G__19595 = (i__7911__auto___19594 + (1));
i__7911__auto___19594 = G__19595;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7918__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__19588_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__19589_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__19589_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq19590){
var G__19591 = cljs.core.first(seq19590);
var seq19590__$1 = cljs.core.next(seq19590);
var G__19592 = cljs.core.first(seq19590__$1);
var seq19590__$2 = cljs.core.next(seq19590__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__19591,G__19592,seq19590__$2);
});
