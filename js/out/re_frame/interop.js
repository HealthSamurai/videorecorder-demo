...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__13687 = cljs.core.instance_QMARK_;
var expr__13688 = reactive_val;
if(cljs.core.truth_((pred__13687.cljs$core$IFn$_invoke$arity$2 ? pred__13687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__13688) : pred__13687.call(null,reagent.ratom.RAtom,expr__13688)))){
return "ra";
} else {
if(cljs.core.truth_((pred__13687.cljs$core$IFn$_invoke$arity$2 ? pred__13687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__13688) : pred__13687.call(null,reagent.ratom.RCursor,expr__13688)))){
return "rc";
} else {
if(cljs.core.truth_((pred__13687.cljs$core$IFn$_invoke$arity$2 ? pred__13687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__13688) : pred__13687.call(null,reagent.ratom.Reaction,expr__13688)))){
return "rx";
} else {
if(cljs.core.truth_((pred__13687.cljs$core$IFn$_invoke$arity$2 ? pred__13687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__13688) : pred__13687.call(null,reagent.ratom.Track,expr__13688)))){
return "tr";
} else {
return "other";
}
