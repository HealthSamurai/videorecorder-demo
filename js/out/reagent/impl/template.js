...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7408__auto__,writer__7409__auto__,opt__7410__auto__){
return cljs.core._write(writer__7409__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13487 = o;
(G__13487[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6785__auto__ = !((jsprops == null));
if(and__6785__auto__){
var and__6785__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13495 = jsprops;
(G__13495["defaultValue"] = value);

(G__13495["onChange"] = ((function (G__13495,v,value,on_change){
return (function (p1__13493_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13493_SHARP_);
});})(G__13495,v,value,on_change))
);
...
var vec__13502 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13507 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13507 == null)){
} else {
var key_13508 = temp__4661__auto___13507;
(jsprops["key"] = key_13508);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13510 = (new reagent.impl.template.NativeWrapper());
(G__13510["name"] = c);
...
var G__13512 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13512) : reagent.impl.template.as_element.call(null,G__13512));
} else {
...
var len__7910__auto___13518 = arguments.length;
var i__7911__auto___13519 = (0);
while(true){
if((i__7911__auto___13519 < len__7910__auto___13518)){
args__7917__auto__.push((arguments[i__7911__auto___13519]));

var G__13520 = (i__7911__auto___13519 + (1));
i__7911__auto___13519 = G__13520;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7918__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13516){
var G__13517 = cljs.core.first(seq13516);
var seq13516__$1 = cljs.core.next(seq13516);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13517,seq13516__$1);
});
...
break;
default:
var G__13524 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13524;
continue;
...
var n__7720__auto___13527 = a.length;
var i_13528 = (0);
while(true){
if((i_13528 < n__7720__auto___13527)){
(a[i_13528] = reagent.impl.template.as_element((a[i_13528])));

var G__13529 = (i_13528 + (1));
i_13528 = G__13529;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7720__auto___13530 = a.length;
var i_13531 = (0);
while(true){
if((i_13531 < n__7720__auto___13530)){
var val_13532 = (a[i_13531]);
if((cljs.core.vector_QMARK_(val_13532)) && ((reagent.impl.template.key_from_vec(val_13532) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13531] = reagent.impl.template.as_element(val_13532));

var G__13533 = (i_13531 + (1));
i_13531 = G__13533;
continue;
} else {
}
...
var ctx = ({});
var vec__13537 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13537,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13537,(1),null);
...
var G__13541 = (cljs.core.count(argv) - first_child);
switch (G__13541) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13541){
