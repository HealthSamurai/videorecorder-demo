...
var digit_15818 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_15819__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_15819__$1 > (0))){
var digit_15820__$1 = (digit_15818 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_15820__$1));

var G__15821 = (vlq_15819__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__15822 = (vlq_15819__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_15818 = G__15821;
vlq_15819__$1 = G__15822;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_15818));
}
break;
}
...
var G__15823 = i__$1;
var G__15824 = result__$1;
var G__15825 = shift__$1;
i = G__15823;
result = G__15824;
shift = G__15825;
continue;
